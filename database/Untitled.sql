...
--
-- Host: localhost    Database: pastedoc
-- ------------------------------------------------------
...
CREATE TABLE `docs` (
  ...
  `doc_password` varchar(60) DEFAULT NULL,
  `doc_content` text NOT NULL,
  `creation_da` datetime NOT NULL,
...
INSERT INTO `docs` VALUES (1,1,'Test','Tester',NULL,'This is simply a test','2020-01-01 00:00:00','1','1');
...
INSERT INTO `users` VALUES (1,'John','j@gmail.com','password',NULL);
...
-- Dump completed on 2020-07-29 14:46:00
